...
In this hands-on, I will learn to be able create the followings data visualisation by using R packages:
...
The code chunk below is used to import *eventlog.csv* file into R environment and called the data frame as *attacks*.
...
-   [`theme_tufte()`](https://jrnold.github.io/ggthemes/reference/theme_tufte.html) of [**ggthemes**](https://jrnold.github.io/ggthemes/reference/) package is used to remove unnecessary chart junk. To learn which visual components of default ggplot2 have been excluded, this line can be commented out to examine the default plot.
...
This section will show how to plot a cycle plot showing the time-series patterns and trend of visitor arrivals from Vietnam programmatically by using ggplot2 functions.
