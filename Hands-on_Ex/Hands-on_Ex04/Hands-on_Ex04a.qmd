...
![](images/ridgeline-plot.png){width="590"}
...
By using either *geom_ridgeline_gradient()* or g*eom_density_ridges_gradient()*, we. can have colors under the ridgeline that vary alongside the x axis. However, they do not allow for alpha transparency in the fill. For technical reasons, we can have changing fill colors or transparency but not both.
