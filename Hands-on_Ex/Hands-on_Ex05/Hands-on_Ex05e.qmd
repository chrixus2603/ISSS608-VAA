...
In this hands-on exercise, I will gain hands-on experiences on designing treemap using appropriate R packages. The hands-on exercise consists of three main section; learning how to manipulate transaction data into a treemap strcuture by using selected functions provided in dplyr package, learning how to plot static treemap by using treemap package, and learning how to design interactive treemap by using d3treeR package.
...
In this exercise, *REALIS2018.csv* data will be used. This dataset provides information of private property transaction records in 2018.
...
The data.frame *realis2018* is in trasaction record form, which is highly disaggregated and not appropriate to be used to plot a treemap. Here's the steps to prepare the data.frame that is appropriate for treemap visualization:
