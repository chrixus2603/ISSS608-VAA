...
In this hands-on exercise, I will learn how to create a proportional symbol map showing the number of wins by Singapore Pools' outlets using an R package called **tmap**, and also:
...
Before the session is ended, it is wiser to switch tmap's Viewer back to plot mode by using the code chunk below.
